...
from data.config import SUPPORT_USER_NAME, CHANNEL_LINK
...
menu_structure = {
    "users_main_menu": {
        ...
        "options": [
            ...
            {"text": "📊 تراکنش های من", "callback_data": "my_transactions"},
            {"text": "☎️ پشتیبانی", "url": f"{SUPPORT_USER_NAME}"},
            {"text": "📚 آموزش", "callback_data": "how_to's"},
